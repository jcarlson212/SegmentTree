...
class SegTree {
    private:
        ...
        void insert_helper(int index, int value, int seg_index, int left_index, int right_index){
    ...
    public:
        SegTree(vector<int> input_array){
        ...
        int build_seg_tree(int seg_index, int left_index, int right_index){
            if(right_index == left_index){
                ...
                int left_sum = build_seg_tree(get_left_child_index(seg_index), left_index, (left_index + right_index)/2);
                int right_sum = build_seg_tree(get_right_child_index(seg_index), (left_index + right_index)/2 + 1, right_index);
